...
def check_for_winner(board):
    empty_spaces = False
    for condition in get_win_conditions:
        markers = []        
        for position in condition:
            row = position[0]
            column = position[1]
            markers.append(board[row][column])
...
# print(check_for_winner(my_board))
# quit()

## Check winning board
# my_winning_board = [['X', 'X', 'X'], ['', '', ''], ['O', 'O', '']]
# print_board(my_winning_board)
# print(check_for_winner(my_winning_board))
# quit()

## Check tied board
# my_tied_board = [['X', 'X', 'O'], ['O', 'O', 'X'], ['X', 'O', 'X']]
# print_board(my_tied_board)
# print(check_for_winner(my_tied_board))
# quit()
